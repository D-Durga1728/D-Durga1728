...
- Created **interactive dashboards** using Power BI and Tableau.  
- Experience with **data processing pipelines** using Pandas and Spark.  
- Hands-on experience deploying **machine learning models**.  
- Continuously improving skills through certifications and real-world projects.  
...
### [CardioRisk_ML-Durga](https://github.com/D-Durga1728/CardioRisk_ML-Durga)  
Predicting cardiovascular risk using ML: preprocessing, feature engineering, model training (Logistic Regression, Random Forest, XGBoost), and evaluation.  
![CardioRisk Demo](https://media.giphy.com/media/3o7abKhOpu0NwenH3O/giphy.gif)

### [Wine Quality Prediction](https://github.com/D-Durga1728/wine-quality-prediction-r)  
Exploratory data analysis and predictive modeling using R.  
![Wine Quality Demo](https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif)

### [Flight Price Visualisation](https://github.com/D-Durga1728/flight-price-visualisation)  
Interactive Jupyter Notebook visualizing flight price trends.  
![Flight Price Demo](https://media.giphy.com/media/3o6ZsX7uJX5zvHqkTa/giphy.gif)

---

## 📜 Certifications

- ![IBM Badge](https://img.shields.io/badge/IBM-Data_Analytics-blue?style=for-the-badge&logo=IBM&logoColor=white) IBM Data Analytics Professional Certificate  
- ![Power BI Badge](https://img.shields.io/badge/Power_BI-DA_Associate-F2C811?style=for-the-badge&logo=power-bi&logoColor=black) Power BI Data Analyst Associate  
- ![Tableau Badge](https://img.shields.io/badge/Tableau-Desktop_Specialist-E97627?style=for-the-badge&logo=tableau&logoColor=white) Tableau Desktop Specialist  
